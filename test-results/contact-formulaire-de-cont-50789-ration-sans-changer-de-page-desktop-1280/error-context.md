...
- Name: contact.spec.ts >> formulaire de contact >> une saisie valide affiche l’état de démonstration sans changer de page
- Location: tests\contact.spec.ts:102:3
      ...
      - generic [ref=e27]:
        - generic [ref=e28]:
          ...
          - generic [ref=e30]:
            - generic [ref=e31]:
              - generic [ref=e32]: Nom *
              - textbox "Nom" [ref=e33]: Camille Dubreuil
            - generic [ref=e34]:
              - generic [ref=e35]: Email *
              - textbox "Email" [ref=e36]: camille.dubreuil@example.com
            - generic [ref=e37]:
              - generic [ref=e38]: Message *
              - textbox "Message" [active] [ref=e39]: Un message de démonstration suffisamment long pour passer la validation.
